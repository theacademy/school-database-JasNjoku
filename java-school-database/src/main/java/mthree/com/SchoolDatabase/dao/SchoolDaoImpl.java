...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT course.courseCode, course.courseDesc, COUNT(DISTINCT course_student.student_id) AS numStudents " +
                "FROM course LEFT JOIN course_student ON course.cid = course_student.course_id " +
